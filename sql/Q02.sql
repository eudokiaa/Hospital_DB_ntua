...
SELECT
    ...
    CASE WHEN COUNT(DISTINCT ss.Shift_id) > 0 THEN 'YES' ELSE 'NO' END AS Had_Shift_This_Year,
    COUNT(DISTINCT ss.Shift_id)                                          AS Total_Shifts_This_Year,
...
-- Επεμβάσεις ως κύριος χειρουργός (Role = 'main')
